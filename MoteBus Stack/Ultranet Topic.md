...
### mpodman
 ...
 | <div style="width: 150pt">topic | <div style="width: 230pt">description | <div style="width: 100pt">payload | <div style="width: 100pt">result|
|:------------ |:-----------|:-------|:-------|   
   | helm://list      | list releases (= mpod_name)| {"namespace":"default"} | { ErrCode: 0, ErrMsg: 'OK', data: 'NAME         \tNAMESPACE\tREVISION\tUPDATED                                  \tSTATUS  \tCHART          \tAPP VERSION\n' + 'aimkt-mariadb\tdefault  \t3       \t2021-05-09 14:03:55.641298661 +0800 +0800\tdeployed\tmariadb-9.3.8  \t10.5.9     \n' + 'aimkt-minio  \tdefault  \t1       \t2021-05-13 15:28:34.024767778 +0800 +0800\tdeployed\tminio-6.7.7    \t2021.4.22  \n' + 'aimkt-mongodb\tdefault  \t1       \t2021-03-31 12:37:00.223497527 +0800 +0800\tdeployed\tmongodb-10.11.1\t4.4.4      \n' } |
