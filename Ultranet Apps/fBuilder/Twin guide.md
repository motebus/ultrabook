# Twin Clocking
Clouder interns are usually requested to set up a clock-in flow on fBuilder

> The purpose of "clocking" is not only checking if you've arrive on time at work, but to test the QRun system as well, it is a simple method for maintainers at YPCloud to identify bugs and make improvements
